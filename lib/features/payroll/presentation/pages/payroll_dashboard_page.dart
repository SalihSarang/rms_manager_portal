...
import 'package:manager_portal/features/payroll/presentation/widgets/payroll_dashboard/payroll_dashboard_view.dart';
...
class PayrollDashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<PayrollDashboardCubit>()..loadPayrollData(),
